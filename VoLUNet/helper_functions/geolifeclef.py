...
class GeoLifeCLEFDataset(Dataset):
    ...
    def preprocess(self):
        ...
        # print(length)
        # if '' in labels_list_all or 'label' in labels_list_all:
        #     print('error')
        cal = np.zeros((length))
        # generate itemlist
        res = []
...
if __name__ == '__main__':
    ds = GeoLifeCLEFDataset(
            img_dir='../../../data/geolifeclef-2024',
            csv_path='../../../data/geolifeclef-2024/geolifeclef_data.csv',
            split='train',
            transform=None
        )
    print('len(ds):', len(ds))
